...
public class AudioThreadBruitage1 extends Thread implements Runnable 
{
    static String path = "" ;
    ...
    public AudioThreadBruitage1( String pPath , float pan1 , float vol1 , boolean muted )
    {
        path = pPath ;
        isSet = true ;
        stopSon = muted ;
        ...
        if( isSet )
        {
            ...
            if ( line.isControlSupported( FloatControl.Type.MASTER_GAIN ) )
            {
	            ...
	            if ( line.isControlSupported( FloatControl.Type.PAN ) )
	            {
		            ...
		            if ( stopSon != true && MenuOption.sliderBruitage[3] != 0 )
		            {
		            	...
		            	try 
			            {
			                ...
			                {
			                	if ( volume.getValue() != MenuOption.sliderBruitage[4] )
					            {
					            	volume.setValue( MenuOption.sliderBruitage[4] ) ;
					            }
